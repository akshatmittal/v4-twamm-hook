...
contract TWAMM is BaseHook, Owned, ITWAMM {
        ...
        returns (bool remainingZeroForOne)
    {
        ...
        // uint256 sellRate0To1As1 = (sellRate0To1 * priceX96) >> FixedPoint96.RESOLUTION;
        uint256 sellRate1To0As0 = (sellRate1To0 << FixedPoint96.RESOLUTION) / priceX96;
        ...
        if (maxAdjustable0To1 != 0) {
            uint256 maxAdjustable1To0 = (maxAdjustable0To1 * priceX96) >> FixedPoint96.RESOLUTION;

            self.orderPool0For1.advanceWithoutCommit(
                Math.mulDiv(maxAdjustable1To0 * params.secondsElapsed, FixedPoint96.Q96, sellRate0To1), // Earnings
                maxAdjustable0To1
            );
            self.orderPool1For0.advanceWithoutCommit(
                Math.mulDiv(maxAdjustable0To1 * params.secondsElapsed, FixedPoint96.Q96, sellRate1To0), // Earnings
                maxAdjustable1To0
            );
